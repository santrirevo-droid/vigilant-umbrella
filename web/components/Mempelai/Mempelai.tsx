...
function PersonBlock({ person, role }: { person: Person; role: CoupleRole }) {
  ...
  return (
    <div data-reveal className="flex flex-col items-center text-center">
      ...
      <p className="mt-2 max-w-xs font-body text-[15px] leading-[1.6] text-ink-soft">
  ...
  return (
    ...
    >
      ...
      <div className="relative mx-auto max-w-md text-center">
        ...
        <p data-reveal className="mx-auto mt-4 max-w-sm font-body text-[15px] leading-[1.6] text-ink-soft">
        ...
        <div className="mt-10 flex flex-col items-center gap-8">
          ...
          <span data-reveal className="font-display text-3xl italic text-gold">
            &amp;
          </span>
